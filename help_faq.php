...
/**
*
* help_faq.php fyrir útgáfu 3.0.7-PL1
* 
* Þýðingu Lokið:      Nei
...
$help = array(
	array(
		0 => '--',
		1 => 'Innskráningar og Skráningar vandamál'
	),
	array(
		0 => 'Hvers vegna get ég ekki skráð mig inn?',
		1 => 'Það eru ýmsar ástæður ef það gerist. Fyrst, athugaðu hvort notendanafn eða lykilorð sé rétt. Ef þau eru það, hafðu samband við eiganda spjallborðsins til að athuga hvort þú sért vannaður. Það er líka möguleiki að bilun sé í spjallborðinu sem veldur því og er á ábyrgð vefstjóra að laga það.'
	),
	array(
		0 => 'Afhverju þarf ég að skrá mig?',
		1 => 'Það þarf ekki alltaf, vefstjóri spjallborðsins ræður því hvort það þurfi til að getað sent inn skilaboð. Hinsvegar þá gefur skráning þér aðgang að ýmislegum góðum hlutum sem gestir hafa ekki, eins og egin smámynd, einkaskilaboð, senda tölvupóst á ákveðna notendur, skrá sig í notendahóp ofl. Það tekur aðeins augnablik að skrá sig svo það er mælt með því.'
	),
	array(
		0 => 'Afhverju skráist ég út sjálfkrafa?',
		1 => 'Ef þú hakar ekki í <em>Skrá mig inn sjálfkrafa</em> kassann þegar þú skráir þig inn, þá skráir borðið þig út eftir ákveðinn tíma. Þetta kemur í veg fyrir misnotkun á aðgangi þínum af eitthverjum öðrum. Til að tolla innskráð/ur hakaðu einfaldlega í kassann þegar þú skráir þig inn. Við mælum þó með því að gera það ekki ef þú ert í almennings tölvu, t.d. á bókasafni, netkaffi, skóla eða álíka. Ef þú sérð ekki þennann möguleika þá hefur vefstjóri bannað hann.'
	),
	array(
		0 => 'Hvernig kem ég í veg fyrir að ég sjáist í <em>Virkir Notendur</em>?',
		1 => 'Í stjórnborðinu þínu, undir "Stillingar", þar finnuru þann möguleika til að <em>Fela mig</em>.'
	),
	array(
		0 => 'Ég gleymdi lykilorðinu mínu!',
		1 => 'Ekki missa þig! Ekki er hægt að finna glatað lykilorð, en það er auðvelt að endurstilla það. Farðu á innskráningarsíðu og smelltu á <em>Ég gleymdi lykilorði mínu</em>. Fylgdu leiðbeiningunum og þú ættir að komast aftur inn eftir enga stund.'
	),
	array(
		0 => 'Ég skráði mig en kemst ekki inn!',
		1 => 'Fyrst, athugaðu notendanafn og lykilorð. Ef þau eru rétt, þá getur eitt eða annað hafa gerst.'
	),
	array(
		0 => 'Ég skráði mig eitthvertíma en get ekki skráð mig inn núna!',
		1 => 'Reyndu að finna tölvupóstinn sem þú fékkst þegar þú skráðir þig, passaðu að nota rétt notendanafn og lykilorð og reyndu aftur. Það er samt möguleiki að vefstjóri eða stjórnandi hafi eytt aðgangi þínum af eitthverri ástæðu. Einnig fjarlægja sum spjallborð óvirka notendur til að minnka stærð gagnagrunnar. Ef það gerðist, prufaðu að skrá þig aftur og vera svolítið virkari.'
	),
	array(
		0 => 'Hvað er COPPA?',
		1 => 'COPPA, eða "Child Online Privacy and Protection Act" frá 1998 er ekkert notað á Íslandi og þau lög gilda ekki á Íslandi. Ef þú sérð COPPA eitthverstaðar þá er spjallborðið vitlaust stillt af stjórnanda eða staðsett í Bandaríkjunum þar sem COPPA verður að vera virkt.',
	),
	array(
		0 => 'Hvers vegna get ég ekki skráð mig ?',
		1 => 'Það er mögulegt að vefstjórinn hafi bannað IP-Tölu þína eða lokað á notendanafnið sem þú valdir. Vefstjóri gæti einnig hafa lokað á allar skráningar. Hafðu samband við vefstjóra fyrir aðstoð.',
	),
	array(
		0 => 'Hvað gerir “Eyða vafrarakökum”?',
		1 => '“Eyða vafrarakökum” fjarlægir allar kökur sem spjallborðið hefur notað til að halda þér innskráðum. Þær innihalda einnig upplýsingar um hvaða pósta þú hefur lesið ef það var virkjað af vefstjóra. Ef þú ert að lenda í vandræðum með að skrá þig inn þá getur það haft góð áhrif.',
	),
	array(
		0 => '--',
		1 => 'Notendastillingar'
	...
	array(
		0 => 'Hvernig breiti ég stillingunum mínum?',
		1 => 'Ef þú ert skráður, þá eru allar stillingar þínar geymdar í gagnagrunninum. Til að breyta þeim, farðu í stjórnborðið þitt; Hægt er að finna hlekkinn í þær efst á öllum síðum. Þetta kerfi leyfir þér að breyta öllum stillingum þínum.'
	),
	array(
		0 => 'Klukkan er vitlaus!',
		1 => 'Það er möguleiki að klukkan sem þú sérð er ekki á réttu tímabelti. Ef það er málið farðu í stjórnboðið þitt og breittu þér á rétt tímabelti.'
	),
	array(
		0 => 'Ég breitti tímabeltinu en klukkan er samt röng!',
		1 => 'Ef þú ert viss um að klukkan sé á réttu tímabelti en samt röng, hafðu samband við vefstjóra.'
	),
	array(
		0 => 'Tungumálið mitt er ekki í listanum!',
		1 => 'Annaðhvort hefur vefstjóri ekki sett upp tungumálið þitt eða enginn hefur þýtt þetta spjallborð í þitt tungumál. Prufaðu að byðja vefstjóra ef þeir geta útvegað tungumálapakka fyrir þitt tungumál. Ef tungumálapakkinn er ekki til þá getur hver sem er þýtt spjallborðið. Meiri upplýsingar um að þýða er að finna á phpbb.com'
	),
	array(
